...
В этом репозитории представлены разнообразные проекты, отличающиеся разной сложностью. Хоть я специализируюсь конкретно на **Frontend** части, в моём портфолио также представлены проекты, в которых есть **Backend**, написанный мною лично.
> Но **FullStack разработчиком** из-за этого я себя не считаю, ибо код в backend части довольно посредственный.
